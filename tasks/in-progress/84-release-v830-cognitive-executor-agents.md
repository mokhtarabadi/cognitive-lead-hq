...
- [ ] Commit via `custom_context_commit_and_clean_task` (release message)
- [ ] Manager: `git tag v8.3.0` + push tag + `gh release create v8.3.0` (ZAC-denied for the agent)

## Acceptance Criteria

- [ ] `<system_version>8.3.0</system_version>` in system-prompt.md
- [ ] CHANGELOG `## [8.3.0] - 2026-08-08` header with Added + Changed entries; `[Unreleased]` gone
- [ ] Release commit on origin/main
- [ ] Tag `v8.3.0` pushed; GitHub release created
