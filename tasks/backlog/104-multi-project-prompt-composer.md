...
**File:** `tasks/backlog/104-multi-project-prompt-composer.md`
**Source:** telegram
**Type:** improvement
**Status:** open
...
- [ ] Design localStorage schema for multi-project state
- [ ] Implement tab bar UI with project switching
- [ ] Implement project CRUD (create, rename, delete)
- [ ] Persist all textarea state per project in localStorage
- [ ] Add "Manage Projects" section/modal
- [ ] Ensure backward compatibility (Default project on first load)
