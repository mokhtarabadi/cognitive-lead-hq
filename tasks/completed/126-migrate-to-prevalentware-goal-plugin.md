...
index 5c32bdc..f4e8db2 100644
--- a/.opencode/memory/opencode_config/global_goal_plugin_upgrade_2026_08_27.md
+++ b/.opencode/memory/opencode_config/global_goal_plugin_upgrade_2026_08_27.md
@@ -7,16 +7,18 @@ updated_at: '2026-08-27T14:30:55.763893+00:00'
...
index cbae9e1..5d30d5a 100644
--- a/LLM.txt
+++ b/LLM.txt
@@ -159,14 +159,7 @@ Write the following JSON (replace `$HOME` with the actual home directory path, a
...
+  "plugin": ["@prevalentware/opencode-goal-plugin"],
   "mcp": {
     "custom_context": {
       "type": "local",
@@ -224,9 +217,22 @@ Write the following JSON (replace `$HOME` with the actual home directory path, a
 }
 ```
