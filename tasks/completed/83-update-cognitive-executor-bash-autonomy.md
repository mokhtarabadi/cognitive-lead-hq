...
**File:** `tasks/in-progress/83-update-cognitive-executor-bash-autonomy.md`
**Source:** orchestrator
**Type:** improvement
**Status:** open
...
+    "*": "allow"
     ...
     "git add*": "deny"
     "git commit*": "deny"
@@ -38,3 +28,72 @@ You are the primary execution engine for the Cognitive Lead AI platform. You rec
