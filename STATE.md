...
- `system-prompt.md` — V4.4 multi-agent prompt defining personas, Agentic Reasoning, and OpenCode protocol (Gemini 3.5 Flash optimized, Brain/Hands separation, SOP Trilogy codified)
