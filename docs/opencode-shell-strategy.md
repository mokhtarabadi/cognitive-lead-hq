<!--
  Vendored from: https://github.com/JRedeker/opencode-shell-strategy
  License: MIT
  Vendored into Cognitive Lead AI HQ to enforce non-interactive shell safety rules.
  Modifications: Reconciled with Cognitive Lead AI ZAC (Zero-Autonomous-Commit) rules.
-->
...
## Cognitive Lead AI HQ Overrides
