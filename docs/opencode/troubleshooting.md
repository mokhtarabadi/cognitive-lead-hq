...
Terminal windowOn Windows, press WIN+R and delete: %USERPROFILE%\.local\share\opencode
...
Terminal windowOn Windows, press WIN+R and delete: %USERPROFILE%\.cache\opencode
