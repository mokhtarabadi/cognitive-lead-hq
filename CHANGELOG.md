...
- **Retired smoke test script removed (Task 177):** deleted `scripts/smoke_test_live.py` (live tester for paused persona/decision servers no longer applicable while servers are disconnected).
